...
public class ConicalFrustumTest {
   ...
   @Test public void setLabelTest1() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", false, cf1.setLabel(null));
   }
   ...
   @Test public void setLabelTest2() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", true, cf1.setLabel("Small1"));
   }
   ...
   @Test public void setRadius1Test1() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", false, cf1.setRadius1(-1));
   }
   ...
   @Test public void setRadius1Test2() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", true, cf1.setRadius1(0.51));
   }
   ...
   @Test public void setRadius2Test1() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", false, cf1.setRadius2(-1));
   }
   ...
   @Test public void setRadius2Test2() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", true, cf1.setRadius2(0.76));
   }
   ...
   @Test public void setHeightTest1() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", false, cf1.setHeight(-1));
   }
   ...
   @Test public void setHeightTest2() {
      ConicalFrustum cf1 = new ConicalFrustum("Small", 0.5, 0.75, 0.25);
      Assert.assertEquals(" ", true, cf1.setHeight(0.26));
   }
   ...
   @Test public void equalsTest1() {
      ...
      Assert.assertEquals(" ", false, cf1.equals(obj));
   }
   ...
   @Test public void equalsTest2() {
      ...
      Assert.assertEquals(" ", false, cf1.equals(cf2));
   }
   ...
   @Test public void equalsTest6() {
      ...
      Assert.assertEquals(" ", true, cf1.equals(cf2));
   }
