...
.data
WelcomeMSG BYTE 'Welcome! This program accepts two inputs from the user. If they both differ by no more than +/-5, then the program will print "Agree". ',0dh,0ah,
...
main PROC
	...
	cmp ax, 5                   ; compare the result in ax to 5
	jle J5                      ; jump to J1 if less than or equal to 5
	...
	J5:                         
	cmp ax, -5                  ; compare the result in ax to -5
	jge J6                      ; jump to J2 if greater than or equal to -5
